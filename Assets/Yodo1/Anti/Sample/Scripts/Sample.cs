...
public class Sample : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        Yodo1U3dAntiAddiction.SetTimeLimitNotifyCallBack(
            ...
            {
                Debug.LogFormat("TimeLimitNotifyCallBack action = {0},eventCode = {1}, title = {2}, context = {3}",
                    action, eventCode, title, content);
    ...
    {
        /* *
         * “Assets/Yodo1/Anti/User/Resources/Yodo1U3dSettings.asset”配置文件中可以配置是否自动初始化
         *  'Assets/Yodo1/Anti/User/Resources/Yodo1U3 dSettings.asset' Automatic initialization can be configured in the configuration file
         */
