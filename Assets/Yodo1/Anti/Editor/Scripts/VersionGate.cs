...
namespace Yodo1.AntiAddiction
{
    ...
    {
        public const string URL_CODING_REPO =
            "https://yodo1-generic.pkg.coding.net/anti-indulged-system-SDK/unity-plugin/";

        public const string SDK_PACKAGE_NAME = "Yodo1AntiAddictionSDK_{0}.unitypackage";

        public static string VersionLatesetUrl
        {
            get { return URL_CODING_REPO + "version.json?version=latest"; }
        }

        public static string SDKUrl
        {
            get { return URL_CODING_REPO + "Yodo1AntiAddictionSDK"; }
        }
