...
namespace Yodo1.AntiAddiction
{
    ...
    {
        public static string Yodo1PluginVersion = Yodo1U3dAntiAddiction.GetSDKVersion();
        ...
        [MenuItem("Yodo1/Yodo1Anti Tools/Update Version")]
        public static string Init()
        {
            VersionGate window = (VersionGate) EditorWindow.GetWindow(typeof(VersionGate));
            window.Show();
            return Yodo1PluginVersion;
        }
        ...
        void OnGUI()
        {
            ...
            {
                String UrlJson =
                    "https://bj-ali-opp-sdk-update.oss-cn-beijing.aliyuncs.com/Yodo1SdkUnityPlugin_Antilndulged/version.json";
                WWWJson = new WWW(UrlJson);
            }
            else if (NeedCheck && WWWJson.isDone)
            {
                Dictionary<string, object> result =
                    (Dictionary<string, object>) Yodo1JSONObject.Deserialize(WWWJson.text);
