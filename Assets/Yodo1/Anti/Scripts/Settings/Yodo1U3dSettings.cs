...
namespace Yodo1.AntiAddiction
{
    public class Yodo1U3dSettings : ScriptableObject
    {
        ...
        [Header("IOS")] [SerializeField] private string _cocoapodsVersion;
        [SerializeField] private Yodo1U3dSettingsData _iosSettings;

        [Header("Android")] [SerializeField] private Yodo1U3dSettingsData _androidSettings;
...
#if UNITY_EDITOR
        public Yodo1U3dSettingsData ActiveSettings
        {
            get { return activeSettings; }
        }

        public string CocoapodsVersion
        {
            get { return _cocoapodsVersion; }
        }
#endif
        ...
        private static Yodo1U3dSettings GetOrCreateInstance()
        {
            ...
            if (instance == null)
            {
                ...
                Debug.Log(">>>> Create new Settings: " +
                          AssetDatabase.AssetPathToGUID(AssetDatabase.GetAssetPath(instance)));
                ...
                Debug.LogFormat("[Yodo1AntiAddictionSDK] Creating settings asset at {0}/{1}", resourcesPath,
                    ResourcesName);
