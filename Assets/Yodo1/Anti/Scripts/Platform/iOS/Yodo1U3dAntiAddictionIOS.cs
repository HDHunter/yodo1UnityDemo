...
namespace Yodo1.AntiAddiction
{
    ...
    public class Yodo1U3dAntiAddictionIOS : Yodo1U3dAntiAddictionImpl
    {
...
#endif
            Debug.LogFormat("Call Yodo1U3dAntiAddictionIOS -> Init : appKey = {0}, extra = {1}, regionCode = {2}",
...
#endif
            Debug.LogFormat("Call Yodo1U3dAntiAddictionIOS -> VerifyPurchase : priceCent = {0}, currency = {1}",
                priceCent, currency);
        }
            ...
            string callbackName)
        {
            ...
            Debug.LogFormat(
                "Call Yodo1U3dAntiAddictionIOS -> VerifyPurchaseYuan : priceYuan = {0}, priceCent = {1}, currency = {2}",
...
#endif
            Debug.LogFormat("Call Yodo1U3dAntiAddictionIOS -> ReportProductReceipt : productReceipt = {0}",
                productReceiptData);
        }
        ...
        {
            string productReceiptData = productReceipt.ToJsonString();
            Debug.LogFormat("Call Yodo1U3dAntiAddictionIOS -> ReportProductReceiptYuan : productReceipt = {0}",
                productReceiptData);
