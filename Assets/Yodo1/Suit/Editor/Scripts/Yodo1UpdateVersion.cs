...
public class Yodo1UpdateVersion : EditorWindow
{
    ...
    {
        Yodo1UpdateVersion window = (Yodo1UpdateVersion)EditorWindow.GetWindow(typeof(Yodo1UpdateVersion));
        window.Show();
    }
    ...
    void OnGUI()
    {
        GUILayout.Label("Version: " + Yodo1PluginVersion, EditorStyles.largeLabel);

        if (NeedCheck && WWWJson == null)
        {
            String UrlJson = VERSION_JSON;
        ...
        {
            GUILayout.Label("Latest Version: " + lastVersionCode);
