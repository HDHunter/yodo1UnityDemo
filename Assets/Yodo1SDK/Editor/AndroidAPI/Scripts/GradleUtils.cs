...
public class GradleUtils : Editor
{
    ...
    public static void ModifyPluginSettingsForADT(string projectPath)
    {
		...
		* include ':KTPlayvideo'
		* include ':yodo1_games'
		* project(':yodo1_games').projectDir = new File(settingsDir, '../../../SDK/Yodo1SDK/Android/yodo1_games')
			* 
			* */
    ...
    {
        string value = "\'" + Yodo1PlayerSettings.bundleId + "\'";
    ...
    {
        string value = "\"" + Yodo1PlayerSettings.bundleVersion + "\"";
    ...
    {
        string value = Yodo1PlayerSettings.bundleVersionCode + "";
