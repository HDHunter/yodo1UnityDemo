...
public class VersionLoader
{
    ...
    public string DownloadUrl { get { return VersionGate.SDKUrl + "?version=" + version; }}
        ...
        Networker.Get(VersionGate.VersionLatesetUrl, (res)=>{
            if(res.success)
            {
                ...
                Networker.Get( ver.DownloadUrl, 
                    ...
                    {
                        // FAIL on load SDK
                        EditorUtility.DisplayDialog("Download SDK Fail", "Load Yodo1AntiAddictionSDK [" + ver.version+"] failed.\n" +loader.text, "OK");
                    }
                });
            }
            else
            {
                ...
                EditorUtility.DisplayDialog("Check version Fail", "Check Yodo1AntiAddictionSDK version [" + VersionGate.VersionLatesetUrl +"] failed.\n" + res.text, "OK");
            }
        });
    }
