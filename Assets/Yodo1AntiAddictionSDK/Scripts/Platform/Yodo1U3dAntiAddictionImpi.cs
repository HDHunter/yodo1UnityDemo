...
namespace Yodo1.AntiAddiction.Platform
{
    using System;
    using Entity;
    ...
    public class Yodo1U3dAntiAddictionImpl
    {
        ...
        /// <param name="gameObjectName">Unity's game object name</param>
        /// <param name="callbackName">Unity's callback method name</param>
        public virtual void Init(string appKey, string extra, string regionCode, string gameObjectName, string callbackName)
        {
        ...
        /// <param name="gameObjectName">Unity's game object name</param>
        /// <param name="callbackName">Unity's callback method name</param>
        public virtual void VerifyPurchase(double priceCent, string currency, string gameObjectName, string callbackName)
        {
        ...
        /// <param name="gameObjectName">Unity's game object name</param>
        /// <param name="callbackName">Unity's callback method name</param>
        public virtual void VerifyPurchaseYuan(double priceYuan, string currency, string gameObjectName, string callbackName)
        {
