using System;
using UnityEngine;
namespace Yodo1.AntiAddiction.Platform.Android
{
    using Entity;
    ...
    public class Yodo1U3dAntiAddictionAndroid : Yodo1U3dAntiAddictionImpl
    {
        ...
        private AndroidJavaObject GetCurrentActivity()
        {
            ...
            try {
                ...
                if (up == null) {
                    Debug.LogWarning("Unity Can't find : com.unity3d.player.UnityPlayer");
                    return null;
                }
        ...
        {
            Debug.LogFormat("Call Yodo1U3dAntiAddictionAndroid -> Init : appKey = {0}, extra = {1}, regionCode = {2}", appKey, extra, regionCode);
            if (currentActivity == null)
            {
                Debug.LogWarning("currentActivity is null");
                return;
            ...
            androidCallClass.CallStatic(METHOD_INIT, currentActivity, appKey, extra, regionCode, gameObjectName, callbackName);
        }
        ...
        {
            Debug.LogFormat("Call Yodo1U3dAntiAddictionAndroid -> VerifyCertificationInfo : accountId = {0}", accountId);
            if (currentActivity == null)
            {
                Debug.LogWarning("currentActivity is null");
                return;
        ...
        {
            Debug.LogFormat("Call Yodo1U3dAntiAddictionAndroid -> VerifyPurchase : price = {0}, currency = {1}", priceCent, currency);
            if (androidCallClass == null)
            {
                Debug.LogWarning("androidCallClass is null");
                return;
        ...
        public override void VerifyPurchaseYuan(double priceYuan, string currency, string gameObjectName, string callbackName)
        {
            ...
            Debug.LogFormat("Call Yodo1U3dAntiAddictionAndroid -> VerifyPurchaseYuan : priceYuan = {0}, priceCent = {1}, currency = {2}", priceYuan, priceCent, currency);
        ...
        public override void ReportProductReceipt(Yodo1U3dProductReceipt productReceipt)
        {
            ...
            Debug.LogFormat("Call Yodo1U3dAntiAddictionAndroid -> ReportProductReceipt : productReceipt = {0}", productReceiptData);
            if (androidCallClass == null)
            {
                Debug.LogWarning("androidCallClass is null !");
                return;
        ...
        {
            string productReceiptData = productReceipt.ToJsonString();
            Debug.LogFormat("Call Yodo1U3dAntiAddictionAndroid -> ReportProductReceiptYuan : productReceipt = {0}", productReceiptData);
