...
using UnityEngine;
namespace Yodo1.AntiAddiction.Entity
{
    ...
    public class Yodo1U3dProductReceipt
    {
        ...
        /// <returns></returns>
        private bool Init(string productId, Yodo1U3dProductType productType, double price, string currency, string orderId)
        {
        ...
        private bool InitFromJsonString(string jsonString)
        {
            ...
            {
                double.TryParse(jsonDict[JSON_PRODUCT_PRICE_KEY].ToString(), System.Globalization.NumberStyles.Float, System.Globalization.CultureInfo.InvariantCulture, out _price);
            }
        ...
        /// <param name="orderId">A string that uniquely identifies a payment transaction.</param>
        /// <returns></returns>
        public static Yodo1U3dProductReceipt Create(string productId, Yodo1U3dProductType productType, double price, string currency, string orderId)
        {
